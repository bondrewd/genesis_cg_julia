...
def main(cafefile, genefile, line_num, output_option):
    ...
    with open(cafefile, "r") as cafin:
        for line in cafin:
            ...
            local_forces = []
            for k in [4, 5, 6, 8, 9, 10, 12, 13, 14, 16, 17, 18]:
    ...
    # plotting...
    # ===========
    fig, ax  = plt.subplots(4, 3, figsize=(20, 8), constrained_layout=True, sharex=True)
    ...
    if output_option == 0:
        ...
        plt.savefig("base_pair_force_comparison.png", dpi=150)
...
if __name__ == '__main__':
    def parse_arguments():
        ...
        parser.add_argument('-t', '--functype',required=False, type=str, default="basepair")
